# Generated by Powerlevel10k configuration wizard on 2019-08-21 at 14:44 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
      debian                  # example user-defined segment (see prompt_example function below)
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded was 76
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND=196
  # Default prompt symbol. Some sim  ->
  ...
  typeset -g POWERLEVEL9K_BATTERY_VISUAL_IDENTIFIER_EXPANSION='${P9K_VISUAL_IDENTIFIER}%k'
  ...
  typeset -g POWERLEVEL9K_DEBIAN_FOREGROUND=039
