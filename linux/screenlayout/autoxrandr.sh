...
if $(xrandr | grep -q "eDP-1 connected");then
    ...
    xrandr --output HDMI-1 --mode 2560x1440 --pos 1280x0 --rotate normal --output DP-1 --off --output HDMI-2 --off --output DP-2 --primary --mode 1280x1024 --pos 0x0 --rotate normal --output HDMI-3 --off --output DP-3 --off
fi
