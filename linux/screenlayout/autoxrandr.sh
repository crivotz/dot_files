...
if $(xrandr | grep -q "DP-1-3 connected");then
    ...
    xrandr --output HDMI-1 --off --output DP-1 --primary --mode 2560x1440 --pos 0x0 --rotate normal --output HDMI-2 --off --output DP-2 --mode 2560x1440 --pos 2560x0 --rotate normal --output HDMI-3 --off --output DP-3 --off
else
